    ...
    <div className='widgetContainer'>
      ...
      <div className='widgetBody'>
        ...
        <svg className='polylines' width='500' height='200'>
          <polyline points={createPolyline(props.state.days, "m")} fill='none' stroke='lightgray' strokeWidth='2' />
          <polyline points={createPolyline(props.state.days, "n")} fill='none' stroke='lightgray' strokeWidth='2' />
        </svg>
      </div>
    </div>
  );
